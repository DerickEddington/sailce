...
This suggests a powerful way of thinking about Willow: a Namespace is a collection of points
(`Entry`s) in a three-dimensional space.  Or more accurately, a _Namespace_ is a mapping from
points in this three-dimensional space to hashes and sizes of [`Payload`](crate::Payload)s.
